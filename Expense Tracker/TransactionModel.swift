...
extension Category {
    ...
    static let bankFee = Category(id: 481, name: "Bank Fee", icon: .hand_holding_usd, mainCategoryId: 4)
    ...
    static let paycheque = Category(id: 701, name:"Pavcheque" ,icon:.dollar_sign, mainCategoryId: 7)
...
extension Category {
    ...
    static let subCategories: [Category] = [
        ...
        .taxi, .mobilePhone, .moviesAndDVDs,
        .bankFee,
        .financeCharge,
        .groceries,
        .restaurants, .rent,
